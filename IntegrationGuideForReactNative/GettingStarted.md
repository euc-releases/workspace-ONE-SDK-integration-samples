...
### Branding
### iOS
To enable brancding add AWSDKDefaultSettings.plist to app bundle and add new entries to the plist. For details on the entries to be added to enable branding in your app, navigate [here](https://code.omnissa.com/web/sdk/Native/airwatch-ios) and search for Branding.
...
### SSO
### iOS
To enable multiple apps built with the plugin share common authentication session and other SDK info, please follow the steps mentioned in the document [here](https://code.omnissa.com/web/sdk/Native/airwatch-ios) under section "Keychain Access Group Entitlements".
