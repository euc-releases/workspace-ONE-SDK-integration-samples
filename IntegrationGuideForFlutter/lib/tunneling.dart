...
class Tunneling extends StatefulWidget {
  @override
  _Tunneling createState() => _Tunneling();

}


class _Tunneling extends State<Tunneling> {
  var _links = 'https://google.com';

  @override
  Widget build(BuildContext context) {
    final appTitle = 'Tunneling';
    return Scaffold(
        appBar: AppBar(
          title: Text(appTitle),
        ),
  ...
  void _handleURLButtonPress(BuildContext context, String url) {
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => WebViewContainer(url, 'Tunneling')));
  }
}