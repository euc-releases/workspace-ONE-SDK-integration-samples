...
/// IntegratedAuthenticationViewController will  delegate the networking logic to URLSessionNetworkingHandler and will get notififed of networking activity by confirming to URLSessionHandlerDelegate protocol
